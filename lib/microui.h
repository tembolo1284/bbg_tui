...
**
** MODIFIED: Bumped limits for Bloomberg POMS-style dense grid rendering.
*/
...
/* ---- MODIFIED LIMITS for POMS grid ---- */
#define MU_COMMANDLIST_SIZE     (1024 * 1024)   /* 1MB: ~12k cells worth of text cmds  */
#define MU_ROOTLIST_SIZE        32
#define MU_CONTAINERSTACK_SIZE  32
#define MU_CLIPSTACK_SIZE       32
#define MU_IDSTACK_SIZE         32
#define MU_LAYOUTSTACK_SIZE     16
#define MU_CONTAINERPOOL_SIZE   128             /* up from 48: more panels/groups       */
#define MU_TREENODEPOOL_SIZE    128             /* up from 48: book/desk/strat hierarchy */
#define MU_MAX_WIDTHS           32              /* up from 16: POMS needs 20+ columns   */
/* ---------------------------------------- */
